    ...
    <div className="flex flex-col gap-1.5">
      ...
      <div className="flex items-center gap-2">
        <input
          ...
          className="min-h-10 min-w-0 flex-1 rounded-full border border-rt-tertiary bg-rt-surface-alt px-3 py-2 font-mono text-[13px] text-rt-ink outline-none focus-visible:ring-2 focus-visible:ring-rt-secondary"
        />
